...
const getSortedUniqueSkills = users => {
  ...
  return users.reduce((allSkills, user) => {const uniqueSkill = user.skills.filter(skill => !allSkills.includes(skill)); allSkills.push(...uniqueSkill); return allSkills}, []).sort();
